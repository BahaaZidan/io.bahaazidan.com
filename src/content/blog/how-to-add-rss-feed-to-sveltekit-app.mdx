...
export async function GET() {
	const feed = new Feed({
		...
		id: 'https://io.bahaazidan.com/',
		link: 'https://io.bahaazidan.com/',
		language: 'en', // optional, used only in RSS 2.0, possible values: http://www.w3.org/TR/REC-html40/struct/dirlang.html#langcodes
		favicon: 'https://io.bahaazidan.com/favicon.ico',
		copyright: `Copyright ${new Date().getFullYear().toString()}, Bahaa Zidan / Gebna`,
		generator: '🍉', // optional, default = 'Feed for Node.js'
		feedLinks: {
			rss: 'https://io.bahaazidan.com/rss.xml',
		},
		author: {
			name: 'Gebna / Bahaa Zidan',
			email: 'io@bahaazidan.com',
			link: 'https://io.bahaazidan.com/whoami',
		},
		ttl: 60,
	});
}
...
export async function GET() {
	...
	for (const article of articles) {
		feed.addItem({
			...
			content: `<p>${article.description}</p> <div style="margin-top: 50px; font-style: italic;"> <strong><a href="https://io.bahaazidan.com${article.path}">Keep reading</a>.</strong> </div> <br /> <br />`,
			link: `https://io.bahaazidan.com${article.path}`,
			author: [
				{
					name: 'Gebna / Bahaa Zidan',
					email: 'io@bahaazidan.com',
